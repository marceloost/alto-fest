...
<body>
    <div class="container">
        ...
        <div class="programacao">
            <p class="titulo-prog">Confira a programação aqui:</p>

            <div class="image-folder">
                <img src="imagens/folder01.png" alt="Folder">
                <div class="info">
                    <h3></h3>
                    <p></p>
                </div>
            ...
            <div class="image-folder">
                <img src="imagens/folder02.png" alt="Folder">
                <div class="info">
                    <h3></h3>
                    <p></p>
                </div>
        ...
        <div class="links">
            <p>Confira todos os detalhes da 9° Alto Fest em nossas páginas do <a href="https://www.facebook.com/profile.php?id=100095396420664" class="link">Facebook</a> e <a href="https://www.instagram.com/altofest_altofeliz/" class="link">Instagram</a>.</p>
        </div>
    </div>
</body>
</html>
